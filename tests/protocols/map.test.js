...
describe('map', () => {
  ...
  test('parse tx', () => {
    const dataObj = {};
    const cell = mapTransactions[0].out[0].tape[1].cell;
  ...
  test('parse tx 2', () => {
    const dataObj = {};
    const cell = mapTransactions[1].out[0].tape[3].cell;
  ...
  test('parse tx 3', () => {
    const dataObj = {};
    const cell = mapTransactions[1].out[0].tape[4].cell;
    const tape = mapTransactions[1].out[0].tape;
    const tx = mapTransactions[1];
  ...
  test('parse REMOVE', () => {
    const dataObj = {};
    const cell = mapTransactions[2].out[0].tape[0].cell;
    const tape = mapTransactions[2].out[0].tape;
  ...
  test('parse DELETE', () => {
    const dataObj = {};
    const cell = mapTransactions[3].out[0].tape[0].cell;
    const tape = mapTransactions[3].out[0].tape;
  ...
  test('parse MSGPACK', () => {
    const dataObj = {};
    const cell = mapTransactions[4].out[0].tape[0].cell;
    const tape = mapTransactions[4].out[0].tape;
  ...
  test('parse JSON', () => {
    const dataObj = {};
    const cell = mapTransactions[5].out[0].tape[0].cell;
    const tape = mapTransactions[5].out[0].tape;
