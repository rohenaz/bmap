...
describe('aip', () => {
  ...
  test('parse tx', () => {
    const dataObj = {};
    const cell = validBobTransaction.out[0].tape[2].cell;
    const tape = validBobTransaction.out[0].tape;
  ...
  test('parse twetch tx', () => {
    const dataObj = {};
    const cell = twetchTransaction.out[0].tape[2].cell;
    const tape = twetchTransaction.out[0].tape;
  ...
  test('unsigned tx', () => {
    const dataObj = {};
    const cell = unsignedBobTransaction.out[0].tape[2].cell;
    const tape = unsignedBobTransaction.out[0].tape;
  ...
  test('indexed tx', () => {
    const dataObj = {};
    const cell = indexedTransaction.out[0].tape[2].cell;
  ...
  test('indexed tx - second AIP', () => {
    const dataObj = {};
    const cell = indexedTransaction.out[0].tape[3].cell;
    const tape = indexedTransaction.out[0].tape;
    const tx = indexedTransaction;
    AIP.handler(dataObj, cell, tape, tx);
    expect(dataObj.AIP.algorithm).toEqual('BITCOIN_ECDSA');
