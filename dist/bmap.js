...
const $9eb49630ba8b5c69$export$fe8725667d42151 = async function(paymail, publicKey) {
    if (typeof window !== "undefined") {
        ...
        const client1 = new (0, $71XCL$moneybuttonpaymailclient.PaymailClient)((0, ($parcel$interopDefault($71XCL$dns))), (0, ($parcel$interopDefault($71XCL$nodefetch))));
            ...
            for (const out of tx.out){
                ...
                for (const cellContainer of tape){
                    ...
                    for (const cellContainer1 of tape){
                        ...
                        let protocolName = "";
                        if (boostChecker && boostChecker(cell1)) protocolName = (0, $8a284ac28b245560$export$13c3c8ee12090ebc).name;
                        else if (_21e8Checker && _21e8Checker(cell1)) protocolName = (0, $370fc9f1fb64c5cc$export$85479a00ad164ad6).name;
                        else continue;
