import {parse as $lNmOP$parse} from "bpu-ts";
...
import {findIndex as $lNmOP$findIndex} from "lodash";
...
const $b7e65d97cc04cb07$export$fe8725667d42151 = async function(paymail, publicKey) {
    if (typeof window !== "undefined") {
        ...
        const client = new (0, $lNmOP$PaymailClient)((0, $lNmOP$dns), (0, $lNmOP$nodefetch));
        return client.verifyPubkeyOwner(publicKey, paymail);
    }
};
...
//         ' '
//     )
const $8cef374217a95a63$var$scriptChecker = (cell)=>{
    // TODO: What is the actual minimum length?
    if (cell.length < 11) // wrong length
    return false;
    // Find OP_IF wrapper
    const startIdx = (0, $lNmOP$findIndex)(cell, (c)=>c.ops === "OP_IF");
    const endIdx = (0, $lNmOP$findIndex)(cell, (c, i)=>i > startIdx && c.ops === "OP_ENDIF");
...
const $8cef374217a95a63$var$handler = ({ dataObj: dataObj , cell: cell , out: out  })=>{
    ...
    ordScript.forEach((push, idx, all)=>{
        // content-type
        if (push.ops === "OP_1") contentType = (0, $69f57829bdd71afa$export$b691916706e0e9cc)(all[idx + 1], "string");
        // data
        if (push.ops === "OP_0") data = (0, $69f57829bdd71afa$export$b691916706e0e9cc)(all[idx + 1]);
    });
    ...
    (0, $69f57829bdd71afa$export$23dbc584560299c3)(dataObj, "Ord", OrdObj);
};
const $8cef374217a95a63$export$ee8aa95bfab51c5 = {
    name: "Ord",
    handler: $8cef374217a95a63$var$handler,
    scriptChecker: $8cef374217a95a63$var$scriptChecker
};
...
const $fe0e4fc54cef5adf$export$6b22fa9a84a4797f = [
    ...
    (0, $8cef374217a95a63$export$ee8aa95bfab51c5)
];
        ...
        for (const [key, val] of Object.entries(tx)){
            ...
            for (const out of tx.out){
                ...
                for (const cellContainer of tape){
                    ...
                    const ordChecker = this.protocolScriptCheckers.get((0, $8cef374217a95a63$export$ee8aa95bfab51c5).name);
                    ...
                    for (const cellContainer of tape){
                        ...
                        if (!cell) throw new Error("empty cell while parsing");
                        let protocolName = "";
                        if (boostChecker && boostChecker(cell)) protocolName = (0, $d821e4307ef5193f$export$13c3c8ee12090ebc).name;
                        else if (_21e8Checker && _21e8Checker(cell)) protocolName = (0, $d660e5f1e72a727e$export$85479a00ad164ad6).name;
                        else if (ordChecker && ordChecker(cell)) protocolName = (0, $8cef374217a95a63$export$ee8aa95bfab51c5).name;
                        else continue;
...
const $fe0e4fc54cef5adf$export$2905b0423a229d9 = async (rawTx)=>{
    const bpuTx = await (0, $lNmOP$parse)({
        tx: {
            r: rawTx
        },
        split: [
...
const $fe0e4fc54cef5adf$export$b2a90e318402f6bc = async (tx, protocols)=>{
    if (typeof tx === "string") {
        ...
        const bobTx = await $fe0e4fc54cef5adf$export$2905b0423a229d9(rawTx);
        if (bobTx) tx = bobTx;
...
export {$fe0e4fc54cef5adf$export$6b22fa9a84a4797f as allProtocols, $fe0e4fc54cef5adf$export$63e9417ed8d8533a as supportedProtocols, $fe0e4fc54cef5adf$export$4f34a1c822988d11 as defaultProtocols, $fe0e4fc54cef5adf$export$894a720e71f90b3c as BMAP, $fe0e4fc54cef5adf$export$54850c299f4a06d8 as fetchRawTx, $fe0e4fc54cef5adf$export$2905b0423a229d9 as bobFromRawTx, $fe0e4fc54cef5adf$export$b2a90e318402f6bc as TransformTx};
