...
import type { BITCOM_HASHED } from "../../types/protocols/bitcomHashed";
import type { PSP as PSPType } from "../../types/protocols/psp";
    ...
    try {
      const paymailPublicKeyVerified = await verifyPaymailPublicKey(
        ...
        pspObj.pubkey,
			...
			pspObj.verified = (pspObj.verified && paymailPublicKeyVerified) as boolean;
		} catch {
			pspObj.verified = false;
		}
	}
